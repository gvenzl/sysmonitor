...
# Since: March 2025
# Author: gvenzl
# Name: build-app-mac.sh
# Description: Build JavaFX app for Mac
#
...
"${JAVA_HOME}"/bin/jpackage \
  ...
  --icon src/main/resources/logos/SysMonitor.icns \
  --app-version "${APP_VERSION}" \
  --vendor "Gerald Venzl" \
  --copyright "© 2025 Gerald Venzl" \
  --mac-package-identifier com.gvenzl.sysmonitor \
  --mac-package-name SysMonitor
